...
#include <RaftRpcHeader.pb.h>

namespace WW
{

bool RaftRpcSerialization::serialize(const std::string & service_name,
...
bool RaftRpcSerialization::deserializeHeader(const std::string & in_buffer,
...
bool RaftRpcSerialization::deserializeArgs(const std::string & in_buffer, google::protobuf::Message * args)
{
